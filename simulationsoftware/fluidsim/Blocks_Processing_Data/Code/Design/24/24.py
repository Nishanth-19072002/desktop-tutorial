...
def execute(inputs):
    ...
    proposed_pumps_cum_hr = flow_cap_pump_req_cum_hr

    inter = round((proposed_pumps_cum_hr/3600)*1000,3)
    ...
    outputs = {
        ...
        "Proposed_pumps_2_numbers_(1W_+_1SB),_flow_per_Pump(Cum/hr)":proposed_pumps_cum_hr,
