function editBlockOutputs(ev){
    block_id = document.getElementById(ev).value;
    if(block_id){
        fetch(`${block_id}/get_edit_block_output_user_ui`,{
            method:'GET',
            headers:{
        ...
        .then(data =>{
            if(data['status'] == 'success'){
                editOutputURL = data['edit_output_params'];
                window.location = editOutputURL;
            }
        })
        .catch(error => console.log("ERROR",error));
    }
    else{
        alert("please select a logic block to edit outputs");
    }
}

document.addEventListener('DOMContentLoaded',load_LB_design_output_params);
document.addEventListener('DOMContentLoaded',load_LB_performance_output_params);
document.addEventListener('DOMContentLoaded',load_LB_lifing_output_params);
document.addEventListener('DOMContentLoaded',load_LB_prognostic_output_params)
function load_LB_design_output_params(){
    fetch('get_design_output_params',{
        method:'GET',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCSRFToken()
...
function load_LB_performance_output_params(){
    fetch('get_performance_output_params',{
        method:'GET',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCSRFToken()
...
function load_LB_lifing_output_params(){
    fetch('get_lifing_output_params',{
        method:'GET',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCSRFToken()
...
function load_LB_prognostic_output_params(){
    fetch('get_prognostic_output_params',{
        method:'GET',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCSRFToken()
...
function deleteRow(button) {
    ...
    if(inputType === "design"){
        ...
        fetch("delete_performance_output",{
            method:'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': getCSRFToken()
        ...
        fetch("delete_prognostics_output",{
            method:'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': getCSRFToken()
...
function save_edited_params_out(id){
    const inputParamType = id.split("-")[1]
    if(inputParamType == "design"){
        var edited_design_params = [];
        const editDesignParamsContainer = document.getElementById('edit-design-params-container');
        ...
        console.log(edited_design_params);
        fetch('put_edited_design_output',{
            method:'POST',
            headers:{
                "Content":"application/json",
                'X-CSRFToken': getCSRFToken()
        ...
        fetch('put_edited_performance_output',{
            method:'POST',
            headers:{
                "Content":"application/json",
                'X-CSRFToken': getCSRFToken()
        ...
        fetch('put_edited_lifing_output',{
            method:'POST',
            headers:{
                "Content":"application/json",
                'X-CSRFToken': getCSRFToken()
        ...
        fetch('put_edited_prognostic_output',{
            method:'POST',
            headers:{
                "Content":"application/json",
                'X-CSRFToken': getCSRFToken()
