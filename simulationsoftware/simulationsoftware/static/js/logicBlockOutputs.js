function getOutputsFromUserLBUI(ev){
    const userSelectLogicBlockBVal = document.getElementById(ev).value;
    if(userSelectLogicBlockBVal){
        fetch(`${userSelectLogicBlockBVal}/get_block_user_outputs_ui`,{
            method:"GET",
            headers:{
        ...
        .then(data=>{
            if(data['status']=='success'){
                const url = data['user_output_url']
                window.location = url
            }
        })
        ...
        alert("Please select a logic block to enter outputs")
    }
}
...
function save_params_output(id){
    ...
    if(typeInput === 'design'){
        ...
        fetch("put_preformance_out_params",{
            method:'POST',
            headers:{
                "Content":"application/json",
                'X-CSRFToken': getCSRFToken()
        ...
        fetch("put_prognostic_out_params",{
            method:'POST',
            headers:{
                "Content":"application/json",
                'X-CSRFToken': getCSRFToken()
