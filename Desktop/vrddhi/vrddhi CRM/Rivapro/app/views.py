...
def submodule_visibility(request, submodule_slug):
    ...
    slug_to_view_map = {
        ...
        'confirmedorderss':'confirmedorderss',
        'dashboard':'dashboard',
        'renewals':'renewals',
        'ienquiry':'ienquiry',
        'i_renewals':'i_renewals',
        'i_dashboard':'i_dashboard',
        'past_policies':'past_policies',
        'retail_past_policies':'retail_past_policies',
        'follow_up':'follow_up',
        'retail_follow_up':'retail_follow_up',
    }

    # Check if the slug exists in the map and redirect
    if submodule.slug in slug_to_view_map:
        return redirect(slug_to_view_map[submodule.slug])  # Redirects to the matching view
