...
from .models import ConfirmedHidrecWash, Enquiry, Hidrec_wash ,Products , Executive,quotation,ConfirmedOrder,FollowUp,ConfirmedOrderFollowUp, Xpredict,BankDetails,CommercialQuote, QuotationItem,companydetails,confirmed_enquiry,RevertRemark
